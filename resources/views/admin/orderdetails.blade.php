@extends('main')
	@section('content')
      ...
      <tr>
        <td colspan="6" width="50" align="center" ><a style="color:white" href="{{URL::to('/delivered/'.$orders->id)}}"><button>Completed</button></a><a style="color:white" href="{{URL::to('/canceled/'.$orders->id)}}"><button>Canceled</button></a></td>
      </tr>
      <?php } ?>
    <?php }?>
